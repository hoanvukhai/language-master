          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                {course ? `Áp dụng cho: ${course.name}` : 'Thiết lập nhịp độ học SRS mỗi ngày'}
              </p>
            </div>
          </div>
          <button
            ...
            <>
              ...
              <div className="bg-slate-50 dark:bg-slate-900/50 rounded-2xl p-4 border border-slate-100 dark:border-slate-700/50">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mb-3">
                  Giới hạn số lượng từ mới học mỗi ngày để tránh quá tải não bộ.
                </p>
                <div className="flex items-center gap-3">
                  <input
                    type="range"
              ...
              <div className="bg-slate-50 dark:bg-slate-900/50 rounded-2xl p-4 border border-slate-100 dark:border-slate-700/50">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mb-3">
                  Tự động khóa bài mới nếu số lượng thẻ cần ôn tập vượt quá ngưỡng này.
                </p>
                <div className="flex items-center gap-3">
                  <input
                    type="range"
              ...
              <div className="bg-slate-50 dark:bg-slate-900/50 rounded-2xl p-4 border border-slate-100 dark:border-slate-700/50">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mb-3">
                  Lượng từ mới sẽ học trong một lượt học (Khuyến nghị: 5 - 10 từ).
                </p>
                <div className="flex items-center gap-3">
                  <input
                    type="range"
              ...
              <div className="bg-slate-50 dark:bg-slate-900/50 rounded-2xl p-4 border border-slate-100 dark:border-slate-700/50">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mb-3">
                  Số lượng thẻ sẽ ôn tập trong một lượt (Khuyến nghị: 30 - 50 thẻ).
                </p>
                <div className="flex items-center gap-3">
                  <input
                    type="range"
